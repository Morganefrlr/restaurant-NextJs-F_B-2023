                            ...
                            <td className="hidden md:block">{item.products[0].title}</td>
                            {
                                ...
                                <td>
                                    <form className="flex items-center justify-center gap-4" onSubmit={(e) => handleUpdate(e,item.id)}>
                                        <input placeholder={item.status} className="p-2 ring-1 ring-red-100 rounded-md"></input>
                                        <button className="bg-red-400 p-2 rounded-full">
                                            <BiEditAlt className='text-gray-100'/>
                                        </button>
                                    </form>
                                </td>) 
                                : 
                                (<td className="py-6 px-1 font-bold text-green-700">{item.status}</td>)
                            }
